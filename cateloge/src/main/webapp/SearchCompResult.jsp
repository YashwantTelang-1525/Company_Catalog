<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
  ...
  <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"></path>
            ...
            <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center" style="margin-right:24px ;">
                <a class="mr-5 hover:text-white" href="searchComp">Back</a>
            </nav>
        ...
        <div class="container">
            <section class="text-gray-600 body-font">
                <div class="flex flex-col text-center w-full mb-15">
                    <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Result of Search</h1>
                </div>
