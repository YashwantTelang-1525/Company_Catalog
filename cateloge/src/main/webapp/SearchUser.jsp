        ...
        <section class="text-gray-600 body-font overflow-hidden">
            <div class="container px-3 py-19 mx-auto">
                <div class="lg:w-4/5 mx-auto flex flex-wrap">
                    <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://source.unsplash.com/400x400/?user,faces">
                    <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">

                        <div class="container px-5 py-24  mx-auto flex flex-wrap items-center">
                            <div class="mb-3 xl:w-96">
                                <form action="searchUser" method="post">
                                    <label for="exampleSearch2" class="form-label inline-block mb-2 text-white-50" style="color: white;">Search User</label>
                                    <input type="text" class="form-control block w-full px-3 py-1.5 text-base font-normal
                                  text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition
                                  ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none
                                " id="name" name="name" placeholder="Search User" />
                                    <br>
                                    <input type="submit" value="Search" class="btn btn-outline-light">
                                    <br> Search the user<br> you want based<br> on user name.
                                </form>
                            </div>
                        </div>
                    </div>
