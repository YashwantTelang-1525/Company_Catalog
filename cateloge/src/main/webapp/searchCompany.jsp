<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <body>
        <section class="text-gray-600 body-font overflow-hidden">
            <div class="container px-3 py-19 mx-auto">
                <div class="lg:w-4/5 mx-auto flex flex-wrap">
                    <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://source.unsplash.com/400x400/?company">
                                ...
                                <div class="container px-3 py-18 mx-auto flex flex-wrap items-center">
                                    <div class="mb-3 xl:w-96">
                                        <form action="searchCompany" method="post">
                                            <label for="exampleSearch2" class="form-label inline-block mb-2 text-white-50" style="color: white;">Search Company</label>
                                            <input type="text" class="form-control block w-full px-3 py-1.5 text-base font-normal
                  text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition
                  ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none
                " id="id" name="id" placeholder="Search Company" />
                                            <br>
                                            <input type="submit" value="Search" class="btn btn-outline-light">
                                        </form>
                                        <br> Searching the company <br> that you want based on<br> company ID
                                    </div>
                                </div>
                            </div>
                        </div>
